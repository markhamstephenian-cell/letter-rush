...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  ...
  "Historical Figure": ["historian", "emperor", "king", "queen", "president", "leader", "general", "politician", "revolutionary", "explorer", "conqueror", "born", "died"],
  ...
  Profession: ["profession", "occupation", "career", "job", "worker", "specialist", "practitioner"],
  "Plant/Flower": ["plant", "flower", "species", "genus", "botanical", "herb", "tree", "shrub", "flora", "blossom"],
  Sport: ["sport", "game", "competition", "tournament", "championship", "played", "athlete", "olympic", "team sport"],
  ...
  "Scientific Term": ["science", "scientific", "theory", "biology", "chemistry", "physics", "cell", "molecule", "process", "phenomenon", "medical"],
  "Board Game": ["board game", "game", "players", "dice", "cards", "tabletop", "strategy game", "parlor"],
};
